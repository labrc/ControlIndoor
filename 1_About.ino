      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            >
              Aún en desarrollo.<br> Control de cultivo basado en ESP8266.
            </h4>
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto" style="text-align=center" >
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">V1k</th>
                      <th class="px-4 py-3">ElGato</th>
				  ...
				  <img alt="Foto" class="center" src=" https://64.media.tumblr.com/f550f686f7af130ff34e8f46136608ac/1cd5473d6171ee42-fe/s640x960/ffd5f674cf77e294563a8cce7a808708443d269e.jpg"> </img>
            </div>
          </div>
        </main>
      </div>
